  ...
  return (
    <header className="bg-green">
      <nav className="flex justify-between items-center w-[98%]  mx-auto">
        <div>
          <img className="h-5 cursor-pointer align-middle" src="logo1.png" alt="station wagon with text that says day tripper"/>
        </div>
        ...
        <div className="flex items-center gap-6">
          <button id="signInBtn" className="bg-terracotta font-kawaii text-white px-4 py-1 m-1 rounded-full hover:bg-sand">Sign in
          </button>
        </div>
      </nav>
    </header>
