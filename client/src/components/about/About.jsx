                ...
                <div className="container mx-auto flex flex-col md:flex-row items-center mt-10 my-12 md:my-24">
                    <div className="flex flex-col w-full lg:w-1/3 justify-center items-start p-8">
                        ...
                        <button id="testimonialBtn">
                            <a href="#" className="bg-gradient-to-r from-coral via-sage to-dirt text-white rounded-full py-2 px-4 border hover:border-transparent hover:text-terracotta id=">Testimonials</a>
                        </button>
                    </div>
                    <div className="p-8 mt-12 mb-6 md:mb-0 md:mt-0 ml-0 md:ml-12 lg:w-2/3 justify-center">
                        <div className="h-48 flex flex-wrap content-center">
                            <div>
                                <img className="inline-block mt-24 md:mt-0 p-8 md:p-0 hover:animate-spin-slow" src="map.png" alt="illustration of map"/>
                            </div>
                        </div>
                    </div>
                </div>
